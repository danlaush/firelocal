...
// ---------------------------------------------------------------------------
// Messages: main thread → SharedWorker
// ---------------------------------------------------------------------------

export type WorkerRequest =
  | { type: 'GET_DOC'; id: string; path: string }
  | { type: 'SET_DOC'; id: string; path: string; data: DocData; merge?: boolean }
  | { type: 'ADD_DOC'; id: string; collectionPath: string; data: DocData }
  | { type: 'UPDATE_DOC'; id: string; path: string; data: DocData }
  | { type: 'DELETE_DOC'; id: string; path: string }
  | { type: 'GET_COLLECTION'; id: string; collectionPath: string; constraints: Constraint[] }
...
// ---------------------------------------------------------------------------
// Messages: SharedWorker → main thread
// ---------------------------------------------------------------------------

export type WorkerResponse =
  | { type: 'RESULT'; id: string; data: unknown }
  | { type: 'ERROR'; id: string; error: string }
  | { type: 'SNAPSHOT'; subId: string; snapshot: RawSnapshot };
